...
"PPMC": "./daq_init.py --dcs --gbtxload 3 --log --trig_source 4 --continuous -f 202.425 --auto_rof --mc_hit --mc_id 1 --name cru-",
# PbPb 44.983 kHz monte carlo emulated pattern
"PBPBMC": "./daq_init.py --dcs --gbtxload 3 --log --trig_source 4 --continuous -f 44.983 --auto_rof --mc_hit --mc_id 0 --name cru-"
}
